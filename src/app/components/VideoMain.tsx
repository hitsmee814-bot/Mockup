    ...
    <section className="relative w-full h-screen overflow-hidden">
      ...
      <div className="absolute inset-0 flex flex-col items-center justify-center text-white z-10">
        <motion.button
          ...
          className="flex items-center gap-2 border border-white text-white font-medium px-8 py-3 rounded-full hover:bg-white hover:text-gray-900 transition-all duration-300 bg-transparent"
        >
          Get Started
        </motion.button>
      </div>
