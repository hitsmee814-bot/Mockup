...
export const travelPackages: TravelPackage[] = [
  {
    ...
    route: "Seminyak → Ubud → Nusa Dua → Tanah Lot",
    ageGroup: "18+ Adults",
    packageType: "Luxury Honeymoon",
    accommodations: [
      { destination: "Seminyak", hotelName: "The Legian Seminyak", nights: 2, mealPlan: "Breakfast & Dinner" },
      { destination: "Ubud", hotelName: "Viceroy Bali Resort", nights: 1, mealPlan: "Breakfast Only" },
      { destination: "Nusa Dua", hotelName: "The Mulia Resort", nights: 1, mealPlan: "All Inclusive" },
    ],
    priceBreakdown: [
      { label: "Accommodation (4 nights)", amount: 32000 },
      { label: "Transfers & Transport", amount: 8000 },
      { label: "Activities & Excursions", amount: 12000 },
      { label: "Meals (as per plan)", amount: 7000 },
      { label: "Travel Insurance", amount: 2000 },
      { label: "Service & Taxes", amount: 4000 },
    ],
    importantNotes: [
      ...
      "Cancellation charges apply as per policy — free cancellation up to 15 days prior",
      "Itinerary sequence may change due to weather or local conditions",
      "Minimum 2 passengers required for this package",
      "Child policy: Children below 5 stay free (without extra bed)",
    ],
    travelAdvisory: [
      "Bali is in a tropical zone — carry light cotton clothing and rain gear",
      "Drink only bottled water; avoid tap water and ice from street vendors",
      ...
      "Monkeys at Ubud Monkey Forest can be aggressive — secure belongings",
      "Emergency: Indonesia country code +62, Tourist Police: 0361-224111",
    ],
    inclusions: [
    ...
    userReviews: [
      {
        ...
        rating: 5,
        date: "2024-11-15",
        comment: "Absolutely magical! The sunset dinner on the beach was the highlight of our honeymoon. The guide was knowledgeable and the hotel was stunning.",
        tags: ["Honeymoon", "Dinner", "Hotel", "Guide"],
      },
      {
        name: "Rahul S.",
        rating: 4,
        date: "2024-10-02",
        comment: "Great itinerary and well-organized. Ubud tour was fantastic. Only wish we had one more day to explore Nusa Penida.",
        tags: ["Itinerary", "Ubud", "Culture"],
      },
      {
        name: "Ananya K.",
        rating: 5,
        date: "2024-09-18",
        comment: "The spa session and water sports were incredible. Loved every moment. Highly recommend for couples!",
        tags: ["Spa", "Water Sports", "Couples"],
      },
      {
        name: "Vikram T.",
        rating: 5,
        date: "2024-08-25",
        comment: "Tanah Lot at sunset was breathtaking. The driver was punctual and friendly throughout. Food at the resort was top-notch.",
        tags: ["Temple", "Transport", "Food", "Resort"],
      },
      {
        name: "Sneha R.",
        rating: 3,
        date: "2024-07-10",
        comment: "Beautiful destination but the monsoon season made some outdoor activities difficult. The hotel upgraded our room which was a nice touch.",
        tags: ["Weather", "Hotel", "Activities"],
      },
      {
        name: "Arjun D.",
        rating: 5,
        date: "2024-06-22",
        comment: "Best honeymoon package we could have asked for. The rice terraces were surreal and the parasailing was an adrenaline rush!",
        tags: ["Honeymoon", "Adventure", "Water Sports", "Ubud"],
      },
      {
        name: "Meera J.",
        rating: 4,
        date: "2024-05-30",
        comment: "Loved the cultural experiences — the temple purification ritual was deeply moving. Wish the spa session was longer though.",
        tags: ["Culture", "Temple", "Spa"],
      },
      {
        name: "Karthik N.",
        rating: 5,
        date: "2024-04-14",
        comment: "Seamless transfers, amazing beach views, and the candlelit dinner was unforgettable. Worth every rupee!",
        tags: ["Transport", "Beach", "Dinner", "Value"],
      },
    ],
    itinerary: [
      {
