...
export default function PremiumFooter() {
  ...
  return (
    <footer className="relative bg-gradient-to-br from-[#071A2F] via-[#0A2540] to-[#0E2F56] text-white overflow-hidden border-t border-[#479EA8]/20">
      ...
      {/* Background Glow */}
      <div className="absolute inset-0 opacity-20 bg-gradient-to-tr from-[#1DA1F2] via-[#479EA8]/30 to-[#00C6FF] blur-3xl" />
      ...
      <motion.div
        ...
        whileInView="show"
        viewport={{ once: true }}
        className="relative max-w-7xl mx-auto px-6 py-14 grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-10 lg:gap-12"
      >
          ...
          <div className="flex gap-3.5 mt-5">
            {[Instagram, Twitter, Facebook].map((Icon, i) => (
              <motion.div
                ...
                className="group p-2 bg-[#0E2F56] rounded-full border border-[#479EA8]/40 hover:border-[#FBAB18] hover:shadow-[0_0_20px_#FBAB18] transition-all duration-300 cursor-pointer"
              >
                <Icon
                  size={17}
                  className="text-[#479EA8] group-hover:text-[#FBAB18] transition-colors duration-300"
        ...
        <motion.div variants={item}>
          ...
          <h3 className="text-lg font-semibold mb-5 text-[#5ED3FF]">
            Explore
          </h3>
        ...
        <motion.div variants={item}>
          ...
          <div className="space-y-3.5 text-white/70 text-sm">
            ...
            <div className="flex items-center gap-3 group">
              ...
              <MapPin
                size={16}
                className="shrink-0 text-[#479EA8] group-hover:text-[#FBAB18] transition-colors duration-300"
              />
            ...
            <div className="flex items-center gap-3 group">
              ...
              <span className="group-hover:text-white transition-colors duration-300 break-all">
                bookings@bonhomiee.com
              </span>
      ...
      {/* Bottom Bar */}
      <div className="relative border-t border-[#479EA8]/40 shadow-[0_-5px_30px_rgba(63,184,255,0.2)] text-center py-5 text-sm text-white/50">
