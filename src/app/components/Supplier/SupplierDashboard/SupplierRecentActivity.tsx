...
import { Activity, CalendarCheck, CreditCard, MessageSquare, XCircle } from "lucide-react"
          ...
          {recentActivity.map((a, i) => {
            ...
            return (
              ...
              >
                ...
                <span className="text-[10px] text-muted-foreground shrink-0 pt-0.5">{a.time}</span>
              </motion.div>
            )
          })}
        </CardContent>
