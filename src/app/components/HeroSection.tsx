...
function TravelCard({
    ...
    return (
        <div
            className={`relative w-full overflow-hidden rounded-[1.25rem] shadow-[0_18px_45px_rgba(14,64,199,0.12)] ${className}`}
        >
...
className="relative hidden min-h-[100svh] w-full items-center justify-end pl-[clamp(16px,2vw,40px)] pr-0 lg:flex lg:w-1/2"                >

                    {/* =====================================================
                        COMPACT COLLAGE
                        Laptop / higher browser zoom
                       ===================================================== */}
                    ...
                    <div className="grid w-full max-w-[760px] grid-cols-2 gap-3 pr-[clamp(8px,1vw,20px)] xl:hidden">
                        ...
                        <div className="flex flex-col gap-3">
                            ...
                            <TravelCard
                                images={travelCards[1]}
                                index={index}
                                className="h-[clamp(210px,30vh,270px)]"
                            />

                            <TravelCard
                                images={travelCards[2]}
                                index={index}
                                className="h-[clamp(160px,23vh,210px)]"
                            />
                        ...
                        <div className="flex items-center">
                            ...
                            <TravelCard
                                images={travelCards[0]}
                                index={index}
                                className="h-[clamp(330px,58vh,440px)]"
                            />
                    ...
                    <div className="hidden w-full max-w-[900px] grid-cols-3 items-center gap-[clamp(10px,1.2vw,20px)] pr-[clamp(8px,1vw,24px)] xl:grid">
                        ...
                        <div className="flex flex-col gap-[clamp(10px,1.2vw,20px)]">
                            ...
                            <TravelCard
                                images={travelCards[1]}
                                index={index}
                                className="h-[clamp(230px,25vh,310px)]"
                            />

                            <TravelCard
                                images={travelCards[2]}
                                index={index}
                                className="h-[clamp(190px,21vh,260px)]"
                            />
                        ...
                        <div className="flex flex-col gap-[clamp(10px,1.2vw,20px)]">
                            ...
                            <TravelCard
                                images={travelCards[3]}
                                index={index}
                                className="h-[clamp(260px,29vh,360px)]"
                            />

                            <TravelCard
                                images={travelCards[4]}
                                index={index}
                                className="h-[clamp(190px,21vh,260px)]"
                            />
                        ...
                        <div className="flex items-center">
                            ...
                            <TravelCard
                                images={travelCards[0]}
                                index={index}
                                className="h-[clamp(340px,48vh,500px)]"
                            />
      ...
      className="relative flex min-h-screen w-full flex-col overflow-hidden px-5 py-20 sm:px-10 lg:min-h-[100svh] lg:w-1/2 justify-center lg:px-[clamp(24px,3vw,56px)]"
                >
                    ...
                    <div className="relative z-10 w-full max-w-[680px]">
                        ...
                        >
                            ...
                            <motion.h1
                                ...
                                style={{
                                    fontSize: "clamp(2.5rem, 4.2vw, 5.5rem)",
                                }}
                            >
                                Travel That
                            </motion.h1>
