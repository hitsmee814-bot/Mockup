        ...
        <section className="bg-white py-14 text-[#1B120B] sm:py-16 lg:py-18">
            <div className="mx-auto max-w-7xl px-5 sm:px-10 lg:px-16">
                ...
                <motion.div initial="hidden" whileInView="visible" viewport={{ once: true }} variants={stagger} className="max-w-5xl">
                    ...
                    {/* CTA */}
                    <motion.div variants={fadeUp} className="mt-7 border-t border-[#1B120B]/10 pt-6 sm:mt-8 sm:pt-7">
                ...
                {/* Final Closing */}
                <motion.div initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} transition={{ duration: 0.8, delay: 0.15, ease: [0.16, 1, 0.3, 1] }} className="mt-14 border-t border-[#1B120B]/10 pt-8 sm:mt-16 sm:pt-10">
                    <p className="max-w-5xl text-3xl font-semibold leading-[1.12] tracking-[-0.04em] sm:text-4xl lg:text-5xl">
                        Because the future of travel isn&apos;t about
                        <span className="text-[#0E40C7]"> going faster.</span>
                        <br className="hidden sm:block" />
                        It&apos;s about
                        <span className="text-[#0E40C7]"> feeling more.</span>
                    </p>
                </motion.div>
