...
import type { AgentEnquiry } from "./types";
...
type FilterStatus = "All" | AgentEnquiry["status"];
...
export function AgentEnquiryTable() {
                    ...
                    {filtered.map((enq, i) => (
                      ...
                      >
                        ...
                        <TableCell>
                          <Tooltip>
                            <TooltipTrigger asChild>
                              <span className="block max-w-[150px] truncate text-sm cursor-pointer hover:text-primary transition-colors">
                                {enq.destination}
                              </span>
                            </TooltipTrigger>
                        ...
                        <TableCell className="text-xs hidden md:table-cell">
                          {new Date(enq.travelDate).toLocaleDateString(
                            "en-IN",
                            {
                              day: "2-digit",
                              month: "short",
                        ...
                        <TableCell>
                          <Tooltip>
                            <TooltipTrigger asChild>
                              <span className="block max-w-[200px] truncate text-xs text-muted-foreground cursor-pointer hover:text-primary transition-colors">
                                {enq.notes}
                              </span>
                            </TooltipTrigger>
