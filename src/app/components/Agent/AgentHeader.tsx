...
import { LogIn, Menu, User2, Wallet, Bell } from "lucide-react";
...
export const AgentHeader = forwardRef<HTMLElement, {}>((props, ref) => {
    ...
    >
      ...
      <div className="max-w-7xl mx-auto h-full flex items-center justify-between px-4 pl-14">
        ...
        <div className="flex items-center gap-2 md:gap-4">
          ...
          {isLoggedIn ? (
            <PremiumButton size="sm" onClick={() => router.push("/Agent/profile")}>
              Profile
              <User2 size={18} />
            </PremiumButton>
          ) : (
            <PremiumButton size="sm" onClick={() => router.push("/auth")}>
              <LogIn size={18} />
